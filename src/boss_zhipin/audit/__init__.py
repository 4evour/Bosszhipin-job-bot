"""Pre-send validation and audit logging for fixed greetings.

Every configured greeting goes through `validate_letter` before being sent to BOSS.
...
# 旧 AI 输出或异常文本误进固定招呼语时，绝不能发送给招聘者。
BLACKLIST: tuple[str, ...] = (
    "Error",
    "Traceback",
    "抱歉，作为",
